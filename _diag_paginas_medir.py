...
TODAS = PAGS + ["index.html", "productos.html", "proceso.html", "contacto.html", "producto.html?p=mobilelink"]
...
with sync_playwright() as p:
    ...
    for pag in TODAS:
        ...
        for w, hgt, tag in VPS:
            ...
            pg.wait_for_timeout(3800 if "producto" in pag else 1400)
            try:
...
with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "_diag_paginas_out.json"), "w", encoding="utf-8") as f:
