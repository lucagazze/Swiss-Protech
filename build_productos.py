...
P = [
  # ---- CADERA
  dict(slug="mobilelink-dual-mobility", key="mobilelink-dual-mobility-2", linea="Cadera", marca="Waldemar Link", img="assets/mobilelink.png",
  ...
  dict(slug="crown-cup", key="crown", linea="Cadera", marca="Advita Ortho (Novation®)", img="assets/crown-cup.png",
  ...
  dict(slug="element", key="element", linea="Cadera", marca="Advita Ortho (Novation®)", img="assets/element.png",
  ...
  dict(slug="lubinus-cup", key="lubinus-cup", linea="Cadera", marca="Waldemar Link", img="assets/lubinus-cup.png",
  ...
  dict(slug="lubinus-spii", key="lubinus-spii-revision", linea="Cadera", marca="Waldemar Link", img="assets/lubinus-spii.png",
  ...
  dict(slug="mp-link", key="mp-link", linea="Cadera", marca="Waldemar Link", img="assets/mp-link.png",
  ...
  # ---- RODILLA
  dict(slug="endomodel-modular", key="endomodel-m-rotational-o-hinged-knee", linea="Rodilla", marca="Waldemar Link", img="assets/endomodel-mod.png",
  ...
  dict(slug="endomodel-hinged", key="endomodel-m-rotational-o-hinged-knee-antialergica", linea="Rodilla", marca="Waldemar Link", img="assets/endomodel-hinged.png",
       clips=EM_CLIPS, stills=EM_STILLS,
  ...
  dict(slug="endomodel-standard", key="endomodel", linea="Rodilla", marca="Waldemar Link", img="assets/endomodel-std.png",
       clips=EM_CLIPS, stills=EM_STILLS,
  ...
  dict(slug="optetrak-cc", key="optetrak-contr-condilar", linea="Rodilla", marca="Advita Ortho (Optetrak®)", img="assets/optetrak-cc.png",
  ...
  dict(slug="optetrak-hiflex", key="optetrak-hi-flex", linea="Rodilla", marca="Advita Ortho (Optetrak®)", img="assets/optetrak-hiflex.png",
  ...
  dict(slug="optetrak-logic", key="optetrak-logic", linea="Rodilla", marca="Advita Ortho (Optetrak®)", img="assets/optetrak-logic.png",
  ...
  dict(slug="uni-sled", key="uni-sled", linea="Rodilla", marca="Waldemar Link", img="assets/uni-sled.png",
  ...
  # ---- CEMENTOS
  dict(slug="copal", key="copal-gc", linea="Cementos", marca="Heraeus Medical", img="assets/copal.png",
  ...
  dict(slug="palacos-mv", key="palacos-mv-y-mvg", linea="Cementos", marca="Heraeus Medical", img="assets/palacos-mv.png",
  ...
  dict(slug="palacos-r", key="palacos-r", linea="Cementos", marca="Heraeus Medical", img="assets/palacos-r.png",
       specs=[["Tipo", "Cemento óseo"], ["Viscosidad", "Alta"]],
       destacados=["Materias primas de alta calidad constante", "Fórmula probada"]),
  dict(slug="palamix-gun", key="palamix-pistola-para-cemento", linea="Cementos", marca="Heraeus Medical", img="assets/palamix-gun.png",
  ...
  dict(slug="palamix-uno", key="palamix-uno-o-duo", linea="Cementos", marca="Heraeus Medical", img="assets/palamix-uno.png",
